...
public class ParroquiaController implements Serializable {
    ...
    @EJB
    private ejb.ParroquiaFacade ejbFacade;
    ...
    public void create() {
        ...
        selected.setParId(getFacade().asignarID());
    ...
    public Parroquia getParroquia(java.math.BigDecimal id) {
